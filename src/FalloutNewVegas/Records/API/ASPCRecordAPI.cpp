...
namespace FNV
{
uint32_t ASPCRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
bool ASPCRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 17: //walla
            ...
            return true;
        case 18: //wallaTriggerCount
            WNAM.value = *(uint32_t *)FieldValue;
            break;
        case 19: //regionSound
            RDAT.value = *(FORMID *)FieldValue;
            return true;
        case 20: //environmentType
            SetEnvironmentType(*(uint32_t *)FieldValue);
            break;
        case 21: //spaceType
            SetSpaceType(*(uint32_t *)FieldValue);
            break;
        default:
            break;
        }
