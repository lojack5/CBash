            ...
            switch(ListFieldID)
                ...
                case 1: //name
                    ...
                    if(FieldValue != NULL)
                        ...
                        strncpy(MOD2->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
                        }
                    break;
                case 2: //texture
            ...
            switch(ListFieldID)
                ...
                case 1: //name
                    ...
                    if(FieldValue != NULL)
                        ...
                        strncpy(MOD3->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
                        }
                    break;
                case 2: //texture
            ...
            switch(ListFieldID)
                ...
                case 1: //name
                    ...
                    if(FieldValue != NULL)
                        ...
                        strncpy(MOD4->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
                        }
                    break;
                case 2: //texture
