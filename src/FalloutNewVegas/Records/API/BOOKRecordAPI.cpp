...
namespace FNV
{
uint32_t BOOKRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
        ...
        case 22: //description
            return STRING_FIELD;
        case 23: //destructableHealth
            return SINT32_FIELD;
        case 24: //destructableCount
            return UINT8_FIELD;
        case 25: //destructableFlags
            return UINT8_FLAG_FIELD;
        case 26: //destructableUnused1
            switch(WhichAttribute)
                {
                case 0: //fieldType
                    return UINT8_ARRAY_FIELD;
