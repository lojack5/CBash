...
namespace FNV
{
uint32_t ECZNRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
bool ECZNRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 8: //data DATA ,, Struct
            DATA.Load();
            DATA->rank = *(int8_t *)FieldValue;
            break;
        case 9: //data DATA ,, Struct
            DATA.Load();
            DATA->minLevel = *(int8_t *)FieldValue;
            break;
        case 10: //data DATA ,, Struct
            DATA.Load();
            DATA->flags = *(uint8_t *)FieldValue;
            break;
        case 11: //data_p DATA ,, Struct
            if(ArraySize != 1)
                break;
