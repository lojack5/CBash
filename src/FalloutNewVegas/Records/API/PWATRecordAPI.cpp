...
namespace FNV
{
uint32_t PWATRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
void * PWATRecord::GetField(FIELD_IDENTIFIERS, void **FieldValues)
    {
    switch(FieldID)
        {
        case 1: //flags1
...
bool PWATRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 18: //flags
            ...
            break;
        case 19: //water
            DNAM.value.water = *(FORMID *)FieldValue;
            return true;
        default:
            break;
        }
...
void PWATRecord::DeleteField(FIELD_IDENTIFIERS)
    {
    GENOBND defaultOBND;
    FNVMODS defaultMODS;
    PWATDNAM defaultDNAM;
    switch(FieldID)
        {
        case 1: //flags1
            SetHeaderFlagMask(0);
        ...
        case 17: //modelFlags
            ...
            return;
        case 18: //flags
            SetFlagMask(defaultDNAM.flags);
            return;
        case 19: //water
            DNAM.value.water = defaultDNAM.water;
            return;
        default:
            return;
        }
