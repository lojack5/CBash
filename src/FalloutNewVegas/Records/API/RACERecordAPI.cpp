		...
		case 44: //maleHead_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD0.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 51: //maleEars_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD1.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 58: //maleMouth_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD2.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 65: //maleTeethLower_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD3.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 72: //maleTeethUpper_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD4.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 79: //maleTongue_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD5.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 86: //maleLeftEye_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD6.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 93: //maleRightEye_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MHMOD7.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 100: //femaleHead_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD0.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 107: //femaleEars_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD1.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 114: //femaleMouth_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD2.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 121: //femaleTeethLower_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD3.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 128: //femaleTeethUpper_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD4.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 135: //femaleTongue_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD5.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 142: //femaleLeftEye_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD6.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 149: //femaleRightEye_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FHMOD7.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 156: //maleUpperBody_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MBMOD0.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 163: //maleLeftHand_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MBMOD1.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 170: //maleRightHand_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MBMOD2.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 177: //maleUpperBodyTexture_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(MBMOD3.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 184: //femaleUpperBody_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FBMOD0.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 191: //femaleLeftHand_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FBMOD1.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 198: //femaleRightHand_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FBMOD2.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
		...
		case 205: //femaleUpperBodyTexture_altTextures
			...
			case 1: //name
				...
				if (FieldValue != NULL)
				{
					...
					strncpy(FBMOD3.MODL->Textures.MODS[ListIndex]->name, (char *)FieldValue, ArraySize);
				}
				break;
			case 2: //texture
