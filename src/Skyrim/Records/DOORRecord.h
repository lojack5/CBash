...
namespace Sk {
	...
	class DOORRecord : public TES5Record // Acoustic Space Record
	{
	public:
		...
		MODEL MODL; // Model
		OptSimpleSubRecord<FORMID> SNAM; // Open Sound
		OptSimpleSubRecord<FORMID> ANAM; // Open Sound
		OptSimpleSubRecord<FORMID> BNAM; // Open Sound
		ReqSimpleSubRecord<uint8_t> FNAM; // Open Sound
