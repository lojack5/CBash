...
namespace Sk
{
	uint32_t ARTORecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
	{
		switch (FieldID)
		{
		case 0: //recType
	...
	void * ARTORecord::GetField(FIELD_IDENTIFIERS, void **FieldValues)
	{
		switch (FieldID)
		{
		case 1: //flags1
	...
	bool ARTORecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
	{
		switch (FieldID)
		{
		case 1: //flags1
	...
	void ARTORecord::DeleteField(FIELD_IDENTIFIERS)
	{
		GENOBND defaultOBND;
		switch (FieldID)
		{
