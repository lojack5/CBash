...
namespace Sk {
	...
	struct BOOKDATA {
		//Originally prolly a packed uint32 but w/e
		uint8_t flags;
		uint8_t type;
		uint16_t junk;
		uint32_t teaches;
	...
	class BOOKRecord : public TES5Record // Acoustic Space Record
	{
	public:
		...
		OptSubRecord<BOOKDATA> DATA;
		OptSimpleSubRecord<FORMID> INAM; // Inventory STAT
										 //ONAM;
		LStringRecord CNAM; // Description
