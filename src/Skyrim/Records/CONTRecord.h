...
namespace Sk {
	...
	class CONTRecord : public TES5Record // Acoustic Space Record
	{
	public:
		...
		OptSubRecord<CONTDATA> DATA;
		OptSimpleSubRecord<FORMID> SNAM; // Sound open name
		OptSimpleSubRecord<FORMID> QNAM; // Sound close name
