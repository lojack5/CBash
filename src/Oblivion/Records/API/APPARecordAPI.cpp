...
namespace Ob
{
uint32_t APPARecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
bool APPARecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 13: //weight
            ...
            break;
        case 14: //quality
            DATA.value.quality = *(float *)FieldValue;
            break;
        default:
            break;
        }
