...
namespace Ob
{
uint32_t SGSTRecord::GetFieldAttribute(FIELD_IDENTIFIERS, uint32_t WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
bool SGSTRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, uint32_t ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 11: //effects
            ...
            break;
        case 12: //uses
            DATA.value.uses = *(uint8_t *)FieldValue;
            break;
        case 13: //value
